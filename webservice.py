...
def upload_image():
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
             ...
             classifier = train(file,"knn_examples/train", model_save_path="trained_knn_model.clf", n_neighbors=2)
...
def train(imgfile,train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False):
